    ...
    outputData(): void {
        if(this.speed > 0) {
            ...
            if(Laya.Browser.onPC) {
                ...
                // LogManager.instance.vConsole("输出：(" + dx.toFixed(2) + " * " + dy.toFixed(2) + ")           " + this.myIndex + "/" + this.touches.length);
            }
            ...
            // LogManager.instance.vConsole("输出：" + this.Horizontal + " * 0" + "，angle=(" + this.angle + ")");
        }
    }
